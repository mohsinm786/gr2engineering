...
const AboutSectionOne = () => {
  ...
  const List = ({ text }: { text: string }) => (
    <p className="mb-5 flex items-start text-lg font-medium text-body-color">
      <span className="mr-4 mt-1 flex h-[30px] w-[30px] items-center justify-center rounded-md bg-primary bg-opacity-10 text-primary shrink-0">
        {/* Check icon */}
  ...
  return (
    <section id="about" className="pt-5 mt-10 pb-7">
