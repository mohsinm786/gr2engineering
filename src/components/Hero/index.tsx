...
const Hero = () => {
  return (
    <>
      <section
        id="home"
        className="relative z-10 overflow-hidden bg-white pb-16 pt-[120px] dark:bg-gray-dark md:pb-[120px] md:pt-[150px] xl:pb-[160px] xl:pt-[180px] 2xl:pb-[200px] 2xl:pt-[210px] mt-[72px]"
      >
          ...
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-1/2">
              <div className="mx-0 ml-0 max-w-[400px] text-left animate-slideInLeft">
                <h1 className="mb-5 text-3xl font-bold leading-tight text-SkyBlue dark:text-white sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
        ...
        <div className="absolute bottom-0 left-0 z-[-1] opacity-90 lg:opacity-100">
          <svg
            width="364"
            height="201"
            viewBox="0 0 364 201"
